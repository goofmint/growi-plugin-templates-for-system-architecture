...
Those diagrams are getting from [dcasati/kubernetes-PlantUML: Kubernetes diagrams using VS Code](https://github.com/dcasati/kubernetes-PlantUML?tab=readme-ov-file#getting-started).
...
Available icons can be found at [dcasati/kubernetes-PlantUML: Kubernetes diagrams using VS Code](https://github.com/dcasati/kubernetes-PlantUML?tab=readme-ov-file#list-of-supported-symbols).

## Basic diagram

A more complete example diagram.
...
## Work with other icons

This diagram works with [Azure icons](https://github.com/plantuml-stdlib/Azure-PlantUML).
...
Other examples can be found at [kubernetes-PlantUML/samples at master · dcasati/kubernetes-PlantUML](https://github.com/dcasati/kubernetes-PlantUML/tree/master/samples).
